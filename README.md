...
| [**Kali Linux**](https://github.com/Hanif-SR/Kali-Linux)                      | Kali playbooks implementing ≥5 WSTG checklist items (information gathering, authentication, input validation, file handling, session management). Includes PoCs and detection mapping. |
| [**Nessus Scanner**](https://github.com/Hanif-SR/Nessus-Utilities)                  | Nessus scans on Kali with templates and exported reports (PDF/CSV). Findings mapped to CVE/CWE and remediation actions. Combines automated scans with manual verification.             |
